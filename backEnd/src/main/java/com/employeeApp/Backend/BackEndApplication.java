...
public class BackEndApplication {
	...
	public CommandLineRunner printAll(ApplicationContext ctx){
		...
		return args->{
			...
			tempEmployeeList.add(new Employee("Santi","Dewi","Male",new Date(),"Single","085252363636","Java BootCamp","Contract","-",new Date(),"SE-PG","CDC- AsterX","nixon.christian@gmail.com","Bandung","Indonesian","people3.jpg"));
			tempEmployeeList.add(new Employee("Astri","Sari","Male",new Date(),"Single","085252363636","Java BootCamp","Contract","-",new Date(),"SE-PG","CDC- AsterX","nixon.christian@gmail.com","Bali","Indonesian","people4.jpg"));
			...
			tempEmployeeList.add(new Employee("Maya","Christian","Male",new Date(),"Single","085252363636","Java BootCamp","Contract","-",new Date(),"SE-PG","CDC- AsterX","nixon.christian@gmail.com","Bali","Indonesian","people10.jpg"));
			tempEmployeeList.add(new Employee("Bayu","Christin","Male",new Date(),"Single","085252363636","Java BootCamp","Contract","-",new Date(),"SE-PG","CDC- AsterX","nixon.christian@gmail.com","Yogyakarta","Indonesian","people7.jpg"));
			...
			tempEmployeeList.add(new Employee("Kanaya","Cahaya","Male",new Date(),"Single","085252363636","Java BootCamp","Contract","-",new Date(),"SE-PG","CDC- AsterX","nixon.christian@gmail.com","Yogyakarta","Indonesian","people9.jpg"));
